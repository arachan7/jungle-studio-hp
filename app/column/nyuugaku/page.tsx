      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              { q: '制服・ランドセル持ち込みはできますか？', a: 'はい。制服・ランドセル・学帽など、実際の入学・卒業グッズを持参して撮影いただけます。' },
              { q: '兄弟・姉妹と一緒に撮影できますか？', a: '可能です。主役が2人の場合は追加料金（¥20,000〜）がかかります。' },
              { q: '当日のヘアメイクはどうすればいいですか？', a: '撮影前にご自宅でセットしてお越しいただくか、スタジオ近くの美容室のご利用をおすすめします。' },
              { q: 'データはいつもらえますか？', a: 'プランにより異なります。ファーストプランは翌日納品、それ以外は後日ダウンロードでお渡しします。' },
            ].map((faq, i) => (
