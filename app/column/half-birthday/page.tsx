      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              { q: 'ハーフバースデーはいつ撮影すればいいですか？', a: '生後5〜7ヶ月の間であれば問題ありません。赤ちゃんの体調が良い日を選んでご予約ください。' },
              { q: 'ハーフケーキの持ち込みはできますか？', a: 'はい、持ち込み可能です。ケーキスマッシュ（ケーキをぐちゃぐちゃにする撮影）もお気軽にご相談ください。' },
              { q: '上の子も一緒に撮影できますか？', a: '可能です。兄弟・姉妹と一緒の写真もとても素敵な思い出になります。' },
              { q: 'グズってしまったら大丈夫ですか？', a: '授乳やおむつ替えのお時間はいつでも取れます。焦らずゆっくり進めますのでご安心ください。' },
            ].map((faq, i) => (
