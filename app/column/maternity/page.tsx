      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              { q: 'お腹を出して撮影しないといけませんか？', a: 'いいえ。お腹を出さないドレスや衣装でのシルエット撮影も可能です。ご希望に合わせてご提案します。' },
              { q: 'パートナーや上の子と一緒に撮影できますか？', a: 'はい。家族みんなで撮影することをおすすめしています。赤ちゃんが生まれる前の貴重な家族写真になります。' },
              { q: '体調が悪い時はキャンセルできますか？', a: 'はい。妊娠中の体調を最優先にお考えください。体調不良の場合はご連絡いただければ日程変更が可能です。' },
              { q: '撮影中に休憩は取れますか？', a: 'いつでも休憩可能です。妊娠中の体への負担を最小限にするよう配慮しています。' },
            ].map((faq, i) => (
