    ...
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-8">
        ...
        <section>
          ...
          <p className="text-stone-700 mt-3">
            生後3ヶ月以降は首が座り始め、赤ちゃんの動きが活発になるため、
        ...
        <section>
          ...
          <div className="space-y-4">
            <FaqAccordion items={[
              ...
              { q: 'スタジオ撮影ですか？自宅への出張撮影もできますか？', a: 'スタジオ撮影もご自宅出張も対応しております。ご自宅出張ご希望の場合は事前にInstagramのDM（@Jungle_studio33）もしくは電話:070-3763-0878にてお問い合わせください。' },
              ...
              { q: '何カットデータをもらえますか？', a: 'プランにより異なります。エコノミープランは50枚、プレミアムプランは80枚、ファーストプランは120枚保証です。' },
