  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              { q: 'いつ予約すればいいですか？', a: '出産前（妊娠後期）に予約されることをおすすめします。生後14日以内に撮影できるよう、日程を調整します。' },
              { q: '上の子も一緒に撮影できますか？', a: 'はい。兄弟写真や家族写真も同時に撮影できます。' },
              { q: '授乳は撮影中にできますか？', a: 'もちろんです。赤ちゃんのペースを最優先にしていますので、授乳・おむつ替えはいつでも可能です。' },
              { q: '双子の場合は対応できますか？', a: '対応可能です。双子の場合はツインプランもご検討ください。事前にご相談ください。' },
            ].map((faq, i) => (
      ...
      <div className="mt-12 bg-stone-900 rounded-2xl p-8 text-center">
        <p className="text-white font-bold mb-2" style={{ fontFamily: 'serif' }}>ニューボーンフォトの予約はこちら</p>
