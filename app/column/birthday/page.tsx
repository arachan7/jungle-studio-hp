      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-8">
        <section>
          ...
          <p className="text-stone-700 mt-3">
            特に1歳のバースデーフォトは「ファーストバースデー」として人気が高いです。
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <FaqAccordion items={[
              ...
              { q: '誕生日プランでは何着着られますか？', a: 'エコノミープランは〜2着、プレミアムプランは〜3着、ファーストプランは〜4着です。' },
              ...
              { q: 'きょうだいをそれぞれ主役で撮影できますか？', a: '基本プランは主役のお子様1名分の内容です。2人目以降の主役追加はプラン料金の50%で対応しています。' },
