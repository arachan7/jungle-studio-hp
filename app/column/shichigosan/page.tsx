        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              { q: '着物はレンタルできますか？持ち込みも可能ですか？', a: 'どちらも対応しています。持ち込みの場合は「肩上げ」「半衿つけ」を事前に済ませた状態でお持ちください。' },
              { q: 'きょうだいの着物・衣装もレンタルできますか？', a: 'はい、ごきょうだいの衣装も別途オプションでレンタル可能です。和装・洋装ともにご用意があります。' },
              { q: '着付け・ヘアセットはプランに含まれますか？', a: '七五三プランにはお子様1名分の着付け・ヘアセットが基本的に含まれています。パパ・ママなど大人の方の着付けは別途オプション料金です。' },
              { q: '七五三のお子様に簡単なメイクはしてもらえますか？', a: '簡単なチーク・リップのみの施術に対応しているスタジオが多いです。' },
